...
- **Core Services & Roles:** Active Directory Domain Services (AD DS), Domain Controller, DNS
- **Networking:** VirtualBox Host-Only Adapter, Static IPv4 Addressing
- **Virtualization Tools:** VirtualBox Guest Additions, Shared Folders
- **Management Tools:** Server Manager, Active Directory Users and Computers (ADUC), Control Panel
- **Command-Line Tools:** `ping`, `net user`
