...
- **Server Operating System:** Windows Server 2022 Desktop Experience
- **Server Name:** `CA-DC-01`
- **Active Directory Domain:** `lab.local`
- **Core Services & Roles:** Active Directory Domain Services (AD DS), Domain Controller
- **Management Tools:** Server Manager
